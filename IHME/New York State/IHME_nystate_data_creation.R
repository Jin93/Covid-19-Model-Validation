...
## training data New York
df7_NY = train_data("New York",7)
df14_NY = train_data("New York",14)
df0_NY = train_data("New York", 0)
df_final_projection_NY = data_IHME[data_IHME$group == "New York", ]
df_final_projection_NY = df_final_projection_NY %>% mutate(measurement_std = sort(seq(0.1, length.out = nrow(df_final_projection_NY),by = 0.1), decreasing= TRUE))
df_final_projection_NY = df_final_projection_NY %>% mutate(time = seq(1, nrow(df_final_projection_NY),1))
write.xlsx(df7_NY,file="~/Dropbox/COVID_19/data/IHME/Newyork/df7_NY_v1.xlsx")
write.xlsx(df14_NY,file="~/Dropbox/COVID_19/data/IHME/Newyork/df14_NY_v1.xlsx")
write.xlsx(df0_NY,file="~/Dropbox/COVID_19/data/IHME/Newyork/df0_NY_v1.xlsx")
write.xlsx(df_final_projection_NY,file="~/Dropbox/COVID_19/data/IHME/Newyork/df_NY_datasettillApril17_V1.xlsx")

## training data France
df7_France = train_data("France",7)
df14_France = train_data("France",14)
write.xlsx(df7_France,file="df7_France_v1.xlsx")
write.xlsx(df14_France,file="df14_France_v1.xlsx")

## training data India
df_India = train_data("India",0)
write.xlsx(df_India,file="df_India.xlsx")
