...
#---Run the lines from 23 to 121 to extract data for NY. The data extracted will be used as a data input in the model_validation.py file---#
...
#---Extracting data for NY---#
## training data New York
df7_NY = train_data("New York",7)
df14_NY = train_data("New York",14)
df0_NY = train_data("New York", 0)
openxlsx::write.xlsx(df7_NY,file="IHME/CurveFit/data/df7_NY_v1.xlsx")
openxlsx::write.xlsx(df14_NY,file="IHME/CurveFit/data/df14_NY_v1.xlsx")
openxlsx::write.xlsx(df0_NY,file="IHME/CurveFit/data/df0_NY_v1.xlsx")
