...
save(out_cvd19_model,file="/Users/yiwang/Dropbox/cvd/cvd_N/model/output/April_21/out_cvd19_model_NY_2weekbeforepeak.RData")


### plot, jhu data
data_sourse_='jhu'
dir_figure="/Users/yiwang/Dropbox/cvd/cvd_N/model/fig/April_24_NY_2weekbeforepeak/"
dir.create(dir_figure)
load("/Users/yiwang/Dropbox/cvd/cvd_N/model/output/April_21/out_cvd19_model_NY_2weekbeforepeak.RData")
...
#get_plot<-function(out_model,data_sourse,dir_fig,name_data_sourse,countries){
  ...
  for(i in 14){#NY
    ...
    write.csv(table,file=paste0(dir_fig,"NY_2week_beforepeak_long_projection.csv"))

    ylim_=range(as.numeric(c(table_est_death,
               table_l_est_death,table_h_est_death)))
    par(mar=c(1,1,1,1))
    pdf(paste0(dir_fig,country,"_",data_sourse,"_death_long_pro_2week_NY.pdf"))
